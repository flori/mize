...
describe Mize do
  ...
  context :memoize_method do
    it 'can cache methods' do
      expect(fb1.__send__(:__memoize_cache__)).to be_empty
      expect(fb2.__send__(:__memoize_cache__)).to be_empty
      ...
      expect(fb1.foo(1, 2)).to eq 5
      expect(fb2.foo(1, 2)).to eq 6
      expect(fb1.__send__(:__memoize_cache__)).not_to be_empty
      expect(fb2.__send__(:__memoize_cache__)).not_to be_empty
    end
  ...
  context :memoize_function do
    it 'can cache functions' do
      expect(FooBar.__send__(:__memoize_cache__)).to be_empty
      ...
      expect(FooBar.__send__(:__memoize_cache__)).not_to be_empty
    end
